...
import static com.example.Varsani.utils.Urls.URL_WORKSHOPS;
...
import com.example.Varsani.Students.Adapters.AdapterUpcomingWorkshops;
...
public class Workshops extends AppCompatActivity {
    private List<UpcomingWorkshopModel> list;
    private AdapterUpcomingWorkshops adapterUpcomingWorkshops;
    ...
    public void myWorkshops(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_WORKSHOPS,
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for(int i=0; i <jsonArray.length();i++){
                                    ...
                                    UpcomingWorkshopModel upcomingWorkshopModel=new UpcomingWorkshopModel(workshopID, mentor, title, workshopDesc, workshopDate,venue,
                                            workshopType, bannerImg, workshopStatus);
                                    list.add(upcomingWorkshopModel);
                                }
                                adapterUpcomingWorkshops=new AdapterUpcomingWorkshops(getApplicationContext(),list);
                                recyclerView.setAdapter(adapterUpcomingWorkshops);
