...
import static com.example.Varsani.utils.Urls.URL_DONATION_HISTORY;
...
import com.example.Varsani.Staff.Patron.Adapters.AdapterDonationHistory;
...
public class DonationHistory extends AppCompatActivity {
    private List<DonationHistoryModel> list;
    private AdapterDonationHistory adapterDonationHistory;
    ...
    public void donationHistory(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DONATION_HISTORY,
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for(int i=0; i <jsonArray.length();i++){
                                    ...
                                    DonationHistoryModel donationHistoryModel=new DonationHistoryModel(donationID,donorID,artistName,donorName,
                                            artID,artistID, amount,paymentMethod,referenceCode,donationStatus,donationDate,title);
                                    list.add(donationHistoryModel);
                                }
                                adapterDonationHistory=new AdapterDonationHistory(getApplicationContext(),list);
                                recyclerView.setAdapter(adapterDonationHistory);
