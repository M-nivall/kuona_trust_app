...
import static com.example.Varsani.utils.Urls.URL_DISPATCHED_DONATIONS;
...
public class DispatchedDonations extends AppCompatActivity {
    private List<DonationsModel> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dispatched_donations);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Dispatched Donations");
    ...
    public void newDonations(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DISPATCHED_DONATIONS,
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for(int i=0; i <jsonArray.length();i++){
                                    ...
                                    DonationsModel donationsModel=new DonationsModel(donationID,donorID,artistName,
                                            donorName,artID,artistID, amount,paymentMethod,referenceCode,donationStatus);
                                    list.add(donationsModel);
                                }
                                adapterDonations=new AdapterDonations(getApplicationContext(),list);
