...
import static com.example.Varsani.utils.Urls.URL_APPROVED_ATTENDANCE;
...
public class ApprovedList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Approved Attendance List");
    ...
    public void getApplicants(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_APPROVED_ATTENDANCE,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                // Inside an activity
                                adapterWorkshopApplicant = new AdapterWorkshopApplicant(ApprovedList.this, list);
