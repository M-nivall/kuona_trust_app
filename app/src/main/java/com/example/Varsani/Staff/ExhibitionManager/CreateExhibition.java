...
import static com.example.Varsani.utils.Urls.URL_CREATE_EXHIBITION;
...
public class CreateExhibition extends AppCompatActivity {
    private EditText edtTitle, edtDescription, edtStartDate, edtEndDate, edtLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePicker = new DatePickerDialog(CreateExhibition.this);

        edtStartDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                datePicker = new DatePickerDialog(CreateExhibition.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void createExhibition(final String pdfname, Uri pdffile) {
        ...
        final String start_date = edtStartDate.getText().toString().trim();
        final String end_date = edtEndDate.getText().toString().trim();
        ...
        if(TextUtils.isEmpty(start_date)){
            Toast.makeText(getApplicationContext(), "Select Starting Date", Toast.LENGTH_SHORT).show();
            btnSubmit.setVisibility(View.VISIBLE);
            progressBar.setVisibility(View.GONE);
            return;
        }
        ...
        try {
            ...
            VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, URL_CREATE_EXHIBITION,
                    response -> {
            ...
            rQueue = Volley.newRequestQueue(CreateExhibition.this);
