...
import static com.example.Varsani.utils.Urls.URL_RECEIVED_DONATIONS;
...
public class ReceivedDonations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Received Donations");
    ...
    public void newDonations(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_RECEIVED_DONATIONS,
