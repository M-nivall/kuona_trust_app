...
public class SelectLogin extends AppCompatActivity {
    ...
    private CardView btn_finance,btn_shipping_mrg,btn_driver,btn_store_mrg, btn_exhibition_manager, btn_tech;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_exhibition_manager = findViewById(R.id.card_exhibition_manager);
        ...
        btn_exhibition_manager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String staff="Exhibition Manager";
