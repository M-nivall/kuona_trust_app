...
public class Accept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (product.equals("6 Pot Bain Marie")){
            unitprice = 20000;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes"+totalcharge);
        ...
        if (product.equals("Steel Burner with Double Frier")){
            unitprice =17500;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes"+totalcharge);
        ...
        if (product.equals("Chacoal-grill-fiber-insulated")){
            unitprice = 6800;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes"+totalcharge);
        ...
        if (product.equals("charcoal oven full stainless barbecue grill")){
            unitprice = 70000;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes"+totalcharge);
        ...
        if (product.equals("wood charcoal cooker")){
            unitprice = 24000;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes"+totalcharge);
        ...
        if (product.equals("Chips warmer with inserts")){
            unitprice = 3000;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes"+totalcharge);
        ...
        if (product.equals("Tea urn commercial  300ltr")){
            unitprice = 9500;
            txt_unitprice.setText("Price: Kes "+unitprice+"/unit");
            totalcharge = unitprice*quantity;
            edt_amount.setText("Total Amount: Kes"+totalcharge);
